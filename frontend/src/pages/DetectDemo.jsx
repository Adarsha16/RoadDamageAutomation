      ...
      <div className="site-container py-12">
        ...
        <div className="mb-10">
          ...
          <p className="text-sm text-text-secondary leading-relaxed max-w-xl">
            Upload a road image or capture one with your camera to identify surface
            defects. The model classifies each detection into one of four damage
            categories and returns bounding boxes with confidence scores.
          </p>
        </div>

        <div className="flex gap-1 p-1 mb-6 border border-border rounded-lg bg-surface w-fit">
          <button
            type="button"
        ...
        {inputMode === 'upload' ? (
          <ImageUpload key={inputKey} onFileSelected={handleUpload} disabled={loading} />
        ) : (
          <CameraCapture key={inputKey} onFileSelected={handleUpload} disabled={loading} />
        )}
